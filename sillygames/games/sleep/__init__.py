...
async def main(robot, commander, phrase):
    ...
    if robot.is_on_charger:
        ...
        await robot.drive_straight(distance_mm(-60), speed_mmps(50)).wait_for_completed()
    ...
    if not charger:
        ...
        try:
            charger = await robot.world.wait_for_observed_charger(timeout=30)
...
def info():
    return {"activation": "go to sleep", "name": "Sleep", "description": "Time to sleep"}
